...
void DrawRateAtFullEfficiency(int centrality=0)
{
  ...
  TString inFileName[INPUTFILES] = {"twoByTwoANDzeroWalls", "twoByTwoANDzeroWallsANDsigmaSubtraction","twoByTwoANDzeroWalls_2GeVBin", "twoByTwoANDzeroWallsANDsigmaSubtraction_2GeVBin"};

  TFile *inFile[INPUTFILES];
  const Int_t COLORS[INPUTFILES] = {kBlack, kRed, kBlue, kMagenta};
